...
def wyslanie(x):
    ...
    hook.send(f'{d.hour+2}godzina,{d.minute} minuta ,{lekcja[x]} <@&803931420664922152>')
    

def wyslanie2(x):
    x
    
    hook.send(f'{d.hour+2}godzina,{d.minute} minuta ,{lekcja[x]} <@&803931239617789962>')
    time.sleep(60)
...
def poniedzialek():
    if d.hour == 7-1 and d.minute == 0:
        wyslanie(4)
        wyslanie2(7)
    elif d.hour == 7-1 and d.minute == 55:
        wyslanie(7)
        wyslanie2(4)
    elif d.hour == 8-1 and d.minute == 45:
        wyslanie(11)
        wyslanie2(3)

    elif d.hour == 9-1 and d.minute ==50:
        wyslanie(9)
        wyslanie2(12)

    elif d.hour == 10-1 and d.minute ==45:
        wyslanie(0)
        wyslanie2(0)

    elif d.hour == 11-1 and d.minute ==35:
        wyslanie(3)
        wyslanie2(7)

    elif d.hour == 12-1 and d.minute ==25:
        wyslanie(9)
        wyslanie2(3)
    elif d.hour == 13-1 and d.minute ==15:
        wyslanie(5)
        wyslanie2(5)
