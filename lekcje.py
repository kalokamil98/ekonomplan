...
def poniedzialek():
    if d.hour == 8 and d.minute == 0:
        wyslanie(4) 
        wyslanie2(7)
    elif d.hour == 8 and d.minute == 55:
        wyslanie(7) 
        wyslanie2(4)
    elif d.hour == 9 and d.minute == 45:
        wyslanie(11) 
        wyslanie2(3)

    elif d.hour == 10 and d.minute ==50:
        wyslanie(9) 
        wyslanie2(12)

    elif d.hour == 11 and d.minute ==45:
        wyslanie(0) 
        wyslanie2(0)

    elif d.hour == 12 and d.minute ==35:
        wyslanie(3) 
        wyslanie2(7)

    elif d.hour == 13 and d.minute ==25:
        wyslanie(9) 
        wyslanie2(11)
    elif d.hour == 14 and d.minute ==15:
        wyslanie(5)  
        wyslanie2(5)
